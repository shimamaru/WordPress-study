...
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/style.css" />
    ...
    <ul class="header-list">
        <li class="header-item">
            <a href="<?php echo esc_url(get_permalink(get_page_by_path('concept'))); ?>" class="header-link">concept</a>
        </li>

        <li class="header-item">
            <a href="<?php echo esc_url(get_permalink(get_page_by_path('menu'))); ?>" class="header-link">menu</a>
        </li>

        <li class="header-item">
            <a href="<?php echo esc_url(get_permalink(get_page_by_path('shoplist'))); ?>" class="header-link">shoplist</a>
        </li>

        <li class="header-item">
            <a href="<?php echo esc_url(get_permalink(get_page_by_path('blog'))); ?>" class="header-link">blog&news</a>
        </li>
    </ul>
</nav>
                ...
                <div class="l-container-s">
                    ...
                    <div class="u-mt">
                        <div class="top-consept-img">
                            <img width="1920" height="954" srcset="img/pic-top-consept.jpg 960w, img/pic-top-consept@2x.jpg 1920w" sizes="(max-width: 767px) 90vw, 960px" src="img/pic-top-consept@2x.jpg" alt="" decoding="async" loading="lazy" />
                        </div>

                        <p class="top-consept-text u-mt">一杯一杯まごころをこめて調製し、新鮮な香りと豊かな 風味のコーヒーを提供します。</p>

                        <p class="top-consept-text02"><span>親譲りの無鉄砲で小供の時から損ばかりしている。</span><span>小学校に居る時分学校の二階から飛び降りて一週間ほど腰を抜かした事がある。</span><span>なぜそんな無闇をしたと聞く人があるかも知れぬ。</span></p>
                            ...
                            <div class="c-posts c-posts--col3">
                                <article class="c-post">
                                    <a href="single.html" class="c-post-thumbnail">
                                        <img width="600" height="369" srcset="img/thumb-post.jpg 1x, img/thumb-post@2x.jpg 2x" src="img/thumb-post@2x.jpg" alt="〇〇の写真。" decoding="async" loading="lazy" />
                                    </a>
